    ...
    <div class="min-h-screen mt-20 py-10 px-4 sm:px-6 lg:px-14 font-light font-roboto">
        <div class="mb-5" x-data="{ activeTab: 1, totalTabs: 6 }">
            <div class="inline-block w-full">
                ...
                <div x-data="{
                    selectedLowonganId: '{{ $selectedLowongan->id ?? '' }}',
                    selectedLowonganName: '{{ $selectedLowongan->posisi->nama_posisi ?? '' }}',
                    selectedLowonganSlug: '{{ $selectedLowongan->slug ?? '' }}',
                    selectedLowonganUuid: '{{ $selectedLowongan->uuid ?? '' }}',
                                                ...
                                                <select name="lowongan_id" id="lowongan_id"
                                                    ...
                                                    @foreach ($lowongans as $lowongan)
                                                        <option value="{{ $lowongan->id }}"
                                                            ...
                                                            data-uuid="{{ $lowongan->uuid }}"
                                                            {{ isset($selectedLowongan) && $selectedLowongan->id == $lowongan->id ? 'selected' : '' }}>
