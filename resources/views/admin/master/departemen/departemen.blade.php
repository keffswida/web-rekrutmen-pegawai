<x-layout.admin-default>
    ...
    <div x-data="masterDepart">
        <div class="panel mt-6">
            <div class="flex items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light">Data Departemen</h5>
                        ...
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div
                                ...
                                <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                                    <h5 class="font-bold text-lg">Tambah Departemen</h5>
        ...
        <table id="list_depart" class="whitespace-nowrap table-hover">
            <thead>
                <tr>
                    <th>ID</th>
                ...
                @foreach ($departemens as $departemen)
                    <tr>
                        ...
                        <td>
                                ...
                                <div class="fixed items-center justify-center inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                    ...
                                    <div class="flex items-start justify-center min-h-screen px-4"
                                        ...
                                        <div
                                            ...
                                            <form action="{{ route('departemen.update', $departemen) }}"
                                                method="post">
                                                @csrf
                                                @method('put')
                                                <div class="p-5">
                                                    ...
                                                    <div class="mb-4">
                                                        <label for="deskripsi" class="form-label">Deskripsi</label>
                                                        <textarea type="text" name="deskripsi" id="deskripsi" placeholder="{{ $departemen->deskripsi }}"
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            disabled>
                                                            <option value="0"
                                                                {{ $departemen->status == '0' ? 'selected' : '' }}>
                                                                AKTIF
                                                            </option>
                                                            <option value="1"
                                                                {{ $departemen->status == '1' ? 'selected' : '' }}>
                                                                NON AKTIF
                                                            </option>
                                                        </select>
                                                    </div>
                                ...
                                <div class="fixed items-center justify-center inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                    ...
                                    <div class="flex items-start justify-center min-h-screen px-4"
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                                                <h5 class="font-bold text-lg">Edit Departemen</h5>
                                                <button type="button" class="text-white-dark hover:text-dark"
                                                    @click="toggle">
                                                ...
                                                <div class="p-5">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" name="nama_departemen"
                                                            id="nama_departemen" class="form-input"
                                                            value="{{ $departemen->nama_departemen }}" required>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label for="deskripsi" class="form-label">Deskripsi</label>
                                                        <textarea type="text" name="deskripsi" id="deskripsi" class="form-input">{{ $departemen->deskripsi }}</textarea>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label for="status" class="form-label">Status</label>
                                                        <select name="status" id="status" class="selectize"
                            ...
                            <!-- Delete -->
                            <form action="{{ route('departemen.destroy', $departemen) }}" method="post"
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("masterDepart", () => ({
                datatable: null,
                init() {
                    this.datatable = new simpleDatatables.DataTable('#list_depart', {
                        sortable: true,
                        searchable: true,
                        perPage: 10,
