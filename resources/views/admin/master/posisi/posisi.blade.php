<x-layout.admin-default>
    ...
    <div x-data="masterPosisi">
        <div class="panel mt-6">
            <div class="flex items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light">Data Posisi</h5>
                        ...
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div
                                ...
                                <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                                    <h5 class="font-bold text-lg">Tambah Posisi</h5>
                                ...
                                <form action="{{ route('posisi.store') }}" method="post">
                                    ...
                                    <div class="p-5">
                                        <div class="mb-4">
                                            <label for="departemen_id" class="form-label">Nama Departemen</label>
                                            <select name="departemen_id" id="departemen_id" class="selectize"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="nama_posisi" id="nama_posisi" class="form-input"
                                                required>
                                        </div>
                                        <div class="mb-4">
        ...
        <table id="list_posisi" class="whitespace-nowrap table-hover">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nama Posisi</th>
            ...
            <tbody>
                @foreach ($posisis as $posisi)
                    <tr>
                        ...
                        <td>{{ $posisi->departemen->nama_departemen }}</td>
                        <td>
                            @if ($posisi->status == '0')
                                    ...
                                    <div class="flex items-start justify-center min-h-screen px-4"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <h5 class="font-bold text-lg">Detail Posisi</h5>
                                            ...
                                            <div class="p-5">
                                                <div class="mb-4">
                                                    <label for="departemen_id" class="form-label">Nama
                                                        Departemen</label>
                                                    <select name="departemen_id" id="departemen_id" class="selectize"
                                                        placeholder="Pilih salah satu..." disabled>
                                                        @foreach ($departemen as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ $posisi->departemen_id == $item->id ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-4">
                                                    <label for="nama_posisi" class="form-label">Nama
                                                        Posisi</label>
                                                    <input type="text" placeholder="{{ $posisi->nama_posisi }}"
                                                        class="form-input disabled:pointer-events-none" disabled />
                                                </div>
                                                <div class="mb-4">
                                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                                    <textarea type="text" name="deskripsi" id="deskripsi" placeholder="{{ $posisi->deskripsi }}"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="status" id="status"
                                                        ...
                                                        disabled>
                                                        <option value="0"
                                                            {{ $posisi->status == '0' ? 'selected' : '' }}>
                                                            AKTIF
                                                        </option>
                                                        <option value="1"
                                                            {{ $posisi->status == '1' ? 'selected' : '' }}>
                                                            NON AKTIF
                                                        </option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="fixed items-center justify-center inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                        ...
                                        <div class="flex items-start justify-center min-h-screen px-4"
                                            ...
                                            <div
                                                ...
                                                <form action="{{ route('posisi.update', $posisi->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                                    <div class="p-5">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" name="nama_posisi" id="nama_posisi"
                                                                class="form-input" value="{{ $posisi->nama_posisi }}"
                                                                required>
                                                        </div>
                                                        <div class="mb-4">
                                                            <label for="deskripsi"
                                                                class="form-label">Deskripsi</label>
                                                            <textarea type="text" name="deskripsi" id="deskripsi" class="form-input">{{ $posisi->deskripsi }}</textarea>
                                                        </div>
                                                        <div class="mb-4">
                                                            <label for="status" class="form-label">Status</label>
                                                            <select name="status" id="status" class="selectize"
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("masterPosisi", () => ({
                datatable: null,
                init() {
                    this.datatable = new simpleDatatables.DataTable('#list_posisi', {
                        sortable: true,
                        searchable: true,
                        perPage: 10,
