                    ...
                    <ul>
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'lowongan' }"
                                @click="activeDropdown === 'lowongan' ? activeDropdown = null : activeDropdown = 'lowongan'">
                                <div class="flex items-center">
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'lowongan' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'lowongan'" x-collapse
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'pelamar' }"
                                @click="activeDropdown === 'pelamar' ? activeDropdown = null : activeDropdown = 'pelamar'">
                                <div class="flex items-center">
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'pelamar' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'pelamar'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
